...
sub select_one {
    my $self = shift;
    return $self->SUPER::select_one(Thnkout::DBI::_expand_args(@_));
}

sub select_row {
    my $self = shift;
    return $self->SUPER::select_row(Thnkout::DBI::_expand_args(@_));
}

sub select_all {
    my $self = shift;
    return $self->SUPER::select_all(Thnkout::DBI::_expand_args(@_));
}
...
sub query {
    my $self = shift;
    return $self->SUPER::query(Thnkout::DBI::_expand_args(@_));
}

package Thnkout::DBI::st;
